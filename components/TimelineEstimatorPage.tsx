...
import { 
  Clock, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Calendar, Activity, BarChart3
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface TimelineEstimatorPageProps {
  navigate?: (page: any) => void;
}

export function TimelineEstimatorPage({ navigate }: TimelineEstimatorPageProps) {
  ...
  const timelineStats = [
    {
      ...
      value: "30+",
      description: "Project timeline templates",
      icon: Clock,
      growth: "Proven methodologies"
    },
    {
      title: "Accuracy Rate",
      value: "95%",
      description: "Timeline estimation precision",
      icon: Target,
      growth: "Reliable predictions"
    },
    {
      title: "Time Savings",
      value: "25%",
      description: "Average project acceleration",
      icon: Activity,
      growth: "Faster delivery"
    },
    {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Timeline <span className="gradient-text-blue">Estimator</span>
              </motion.h1>
              ...
              >
                Advanced timeline estimation with 30+ proven models and 95% accuracy rate. 
                Achieve 25% time savings with 92% on-time delivery across all project types.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Optimize Your Project Timeline?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 30+ timeline models with 95% accuracy and achieve 25% time savings with reliable delivery predictions.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Timeline Accuracy</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">30+ models & 95% precision</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Delivery Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">25% faster & 92% on-time</p>
                  </div>
                </div>
              </div>
            </div>
