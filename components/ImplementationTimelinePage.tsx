...
import { 
  Calendar, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Clock, Activity
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ImplementationTimelinePageProps {
  navigate?: (page: any) => void;
}

export function ImplementationTimelinePage({ navigate }: ImplementationTimelinePageProps) {
  ...
  const timelineStats = [
    ...
    },
    {
      ...
      icon: Clock,
      growth: "Reliable execution"
    },
    {
      title: "Milestone Success",
      value: "99%",
      description: "Milestones achieved on target",
      icon: Target,
      growth: "Precise planning"
    },
    {
      title: "Early Value",
      value: "30 days",
      description: "Time to first measurable value",
      icon: Activity,
      growth: "Quick wins"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Implementation <span className="gradient-text-blue">Timeline</span>
              </motion.h1>
              ...
              >
                Precise implementation timelines with 97% on-time delivery record. 
                8-month average delivery with 99% milestone success and 30-day early value realization.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready for Precise Implementation?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Experience 97% on-time delivery with precise milestone tracking and 30-day early value realization guaranteed.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Reliable Delivery</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">97% on-time & 99% milestone success</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Quick Value</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">8-month delivery & 30-day early wins</p>
                  </div>
                </div>
              </div>
            </div>
