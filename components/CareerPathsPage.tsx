...
import { 
  Compass, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Users, Navigation, MapPin
} from "lucide-react";
...
export function CareerPathsPage({ navigate }: CareerPathsPageProps) {
  ...
  const careerStats = [
    {
      title: "Career Paths",
      value: "100+",
      description: "Comprehensive career trajectories",
      icon: Compass,
      growth: "Growing opportunities"
    },
    {
      title: "Success Stories",
      value: "25,000+",
      description: "Career advancement cases",
      icon: TrendingUp,
      growth: "Proven outcomes"
    },
    {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Career <span className="gradient-text-blue">Paths</span>
              </motion.h1>
              ...
              >
                Strategic career path guidance with 100+ trajectories and 25,000+ success stories. 
                65% average salary increase with 94% job placement success rate.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Navigate 100+ career paths with proven 65% salary increase and 94% job placement success rate.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Career Growth</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">100+ paths & 65% salary increase</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Success Rate</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">25,000+ success stories & 94% placement</p>
                  </div>
                </div>
              </div>
            </div>
