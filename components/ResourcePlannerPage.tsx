...
import { 
  ...
  ArrowRight, Award, Mail, Settings, Activity, BarChart3
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ResourcePlannerPageProps {
  navigate?: (page: any) => void;
}

export function ResourcePlannerPage({ navigate }: ResourcePlannerPageProps) {
  ...
  const resourceStats = [
    {
      ...
      value: "40+",
      description: "Resource allocation frameworks",
      icon: Users,
    ...
    },
    {
      ...
      value: "94%",
      description: "Well-resourced project success",
      icon: CheckCircle,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Resource <span className="gradient-text-blue">Planner</span>
              </motion.h1>
              ...
              >
                Advanced resource planning with 40+ allocation frameworks and 87% efficiency rate. 
                Achieve 35% cost reduction with 94% project success through optimal resource utilization.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Optimize Resource Allocation?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 40+ allocation frameworks with 87% efficiency and achieve 35% cost reduction with strategic resource planning.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Resource Optimization</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">40+ frameworks & 87% efficiency</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Project Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">35% cost reduction & 94% success</p>
                  </div>
                </div>
              </div>
            </div>
