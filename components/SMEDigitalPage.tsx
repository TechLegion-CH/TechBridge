...
import { 
  Building2, Users, TrendingUp, BarChart3, CheckCircle, Star, 
  ArrowRight, Brain, Smartphone, Briefcase, Database, Monitor,
  Clock, Target, Zap, Award, Globe, Search, Bell, MessageSquare,
  Calendar, Mail, Phone, Video, Headphones, DollarSign, Rocket,
  Shield, Settings, Lightbulb, Package, Store
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface SMEDigitalPageProps {
  navigate?: (page: any) => void;
}

export function SMEDigitalPage({ navigate }: SMEDigitalPageProps) {
  ...
  return (
    <div className={`min-h-screen bg-background ${isRTL ? 'rtl' : ''}`}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                SME <span className="gradient-text-blue">Digital Success</span>
              </motion.h1>
              ...
              >
                Affordable digital transformation solutions designed specifically for small and medium enterprises. 
                Compete with larger businesses using powerful yet budget-friendly AI-native tools.
              </motion.p>
            </div>

            {/* SME Digital Benefits Grid */}
            <motion.div
            ...
            >
              {smeDigitalBenefits.map((benefit, index) => (
                <div
                  key={index}
      ...
      {/* SME Solutions Section */}
      <section id="sme-solutions" className="py-16 lg:py-24 bg-gradient-to-br from-blue-50/30 to-background dark:from-blue-950/10 dark:to-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
              ...
              SME <span className="gradient-text-blue">Solutions</span>
            </h2>
            <p className={`text-lg max-w-3xl mx-auto ${
              isDark ? 'text-slate-300' : 'text-slate-600'
            }`}>
              Powerful digital solutions specifically designed and priced for small and medium enterprises 
              to compete effectively in the digital marketplace.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {smeSolutions.map((solution, index) => (
              <motion.div
                key={solution.title}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
              ...
              SME <span className="gradient-text-blue">Success Stories</span>
            </h2>
            <p className={`text-lg max-w-3xl mx-auto ${
              isDark ? 'text-slate-300' : 'text-slate-600'
            }`}>
              Real success stories from small and medium enterprises that transformed their businesses with Delibix.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold ${
              ...
              Ready to Grow Your <span className="gradient-text-blue">SME Business</span>?
            </h2>
            <p className={`text-xl ${
              isDark ? 'text-slate-400' : 'text-slate-500'
            }`}>
              Join 500+ SMEs that have successfully digitized their operations with affordable Delibix solutions.
            </p>
