...
import { 
  ...
  ArrowRight, Award, Mail, Quote, Building
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ClientTestimonialsPageProps {
  navigate?: (page: any) => void;
}

export function ClientTestimonialsPage({ navigate }: ClientTestimonialsPageProps) {
  ...
  const testimonialStats = [
    {
      ...
      value: "1,200+",
      description: "Authentic client feedback collected",
      icon: Quote,
      growth: "Verified reviews"
    },
    {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Client <span className="gradient-text-blue">Testimonials</span>
              </motion.h1>
              ...
              >
                Authentic testimonials from 1,200+ satisfied clients with 98% satisfaction rate. 
                Real experiences and verified success stories from our transformation partners.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Join 1,200+ satisfied clients with 98% satisfaction rate. Experience authentic transformation success with proven results.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Authentic Feedback</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">1,200+ testimonials & 98% satisfaction</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Trusted Partnership</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">97% recommendation & 85% long-term partners</p>
                  </div>
                </div>
              </div>
            </div>
