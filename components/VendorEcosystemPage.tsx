...
import { 
  Boxes, TrendingUp, Target, CheckCircle, Star, 
  ArrowRight, Users, Award, Mail, Network, Globe, Clock
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface VendorEcosystemPageProps {
  navigate?: (page: any) => void;
}

export function VendorEcosystemPage({ navigate }: VendorEcosystemPageProps) {
  ...
  const vendorStats = [
    {
      ...
      value: "500+",
      description: "Curated vendor ecosystem",
      icon: Boxes,
    ...
    },
    {
      ...
      icon: Award,
      growth: "Vetted excellence"
    },
    {
      title: "Procurement Time",
      value: "60%",
      description: "Faster vendor selection",
      icon: Clock,
      growth: "Streamlined process"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Vendor <span className="gradient-text-blue">Ecosystem</span>
              </motion.h1>
              ...
              >
                Curated network of 500+ premium vendors and suppliers. 
                Quality-assured solutions, streamlined procurement, and 60% faster vendor selection for your digital initiatives.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Access Our Premium Vendor Ecosystem
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Connect with 500+ curated vendors and suppliers. Quality-assured solutions with 4.8/5 average rating and 60% faster procurement.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Quality Assured</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">500+ curated vendors with 4.8/5 rating</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Fast Procurement</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">60% faster vendor selection process</p>
                  </div>
                </div>
              </div>
            </div>
