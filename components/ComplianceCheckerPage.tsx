...
import { 
  CheckCircle, TrendingUp, Zap, Target, Shield, Star, 
  ArrowRight, Award, Mail, FileCheck, Activity, BarChart3
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ComplianceCheckerPageProps {
  navigate?: (page: any) => void;
}

export function ComplianceCheckerPage({ navigate }: ComplianceCheckerPageProps) {
  ...
  const complianceStats = [
    {
      ...
      value: "150+",
      description: "Global regulatory frameworks",
      icon: CheckCircle,
    ...
    },
    {
      ...
      value: "99.8%",
      description: "Regulatory adherence success",
      icon: Target,
      growth: "Exceptional compliance"
    },
    {
      ...
      icon: Shield,
      growth: "Secure operations"
    },
    {
      title: "Audit Success",
      value: "98%",
      description: "Successful compliance audits",
      icon: Award,
      growth: "Proven validation"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Compliance <span className="gradient-text-blue">Checker</span>
              </motion.h1>
              ...
              >
                Comprehensive compliance validation with 150+ global standards and 99.8% adherence rate. 
                Achieve 95% risk reduction with 98% audit success through systematic compliance management.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 150+ global standards with 99.8% compliance rate and achieve 95% risk reduction with comprehensive validation tools.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Global Standards</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">150+ frameworks & 99.8% rate</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Audit Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">95% risk reduction & 98% audit success</p>
                  </div>
                </div>
              </div>
            </div>
