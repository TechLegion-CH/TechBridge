...
import { 
  Layers, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Brain, Award, Mail, Users, Clock, Settings, Compass
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ConsultingFrameworksPageProps {
  navigate?: (page: any) => void;
}

export function ConsultingFrameworksPage({ navigate }: ConsultingFrameworksPageProps) {
  ...
  const frameworkStats = [
    {
      ...
      value: "25+",
      description: "Comprehensive frameworks available",
      icon: Layers,
      growth: "Battle-tested"
    },
    {
      title: "Framework Success",
      value: "97%",
      description: "Successful framework application",
      icon: Target,
      growth: "Proven effectiveness"
    },
    {
      title: "Implementation Speed",
      value: "55%",
      description: "Faster with structured frameworks",
      icon: Clock,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Consulting <span className="gradient-text-blue">Frameworks</span>
              </motion.h1>
              ...
              >
                Comprehensive consulting frameworks with 25+ structured approaches. 
                97% framework success rate and 55% faster implementation through proven methodologies and systematic excellence.
              </motion.p>
            </div>
            ...
            >
              ...
              <Button
                ...
                onClick={() => navigate('consulting-methodology')}
              >
                Our Methodology
              </Button>
            </motion.div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Leverage Our Proven Consulting Frameworks
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 25+ comprehensive frameworks with 97% success rate. Accelerate your transformation with structured excellence and systematic approaches.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Structured Excellence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">25+ frameworks & 97% success rate</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Accelerated Implementation</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">55% faster delivery & 99% compliance</p>
                  </div>
                </div>
              </div>
            </div>
