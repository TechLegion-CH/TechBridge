...
import { 
  ...
  ArrowRight, Award, Mail, Clock, Users, BarChart3, 
  DollarSign, Activity, Calendar, Download
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ROIShowcasePageProps {
  navigate?: (page: any) => void;
}

export function ROIShowcasePage({ navigate }: ROIShowcasePageProps) {
  ...
  const roiStats = [
    ...
    },
    {
      title: "Cost Savings",
      value: "$50M+",
      description: "Total client cost savings achieved",
      icon: DollarSign,
      growth: "Massive savings"
    },
    {
    ...
    },
    {
      ...
      value: "8 months",
      description: "Average investment payback time",
      icon: Clock,
      growth: "Fast returns"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ROI <span className="gradient-text-blue">Showcase</span>
              </motion.h1>
              ...
              >
                Exceptional ROI achievements with 320% average returns. 
                $50M+ in cost savings delivered across 500+ transformations with proven 8-month payback periods.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Achieve Exceptional ROI?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Join clients achieving 320% average ROI with $50M+ in cost savings. Calculate your potential returns today.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Exceptional Returns</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">320% average ROI & 8-month payback</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Massive Savings</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">$50M+ saved & 65% efficiency gains</p>
                  </div>
                </div>
              </div>
            </div>
