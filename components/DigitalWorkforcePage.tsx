...
import { 
  Users, Brain, Zap, TrendingUp, CheckCircle, Star, 
  ...
  Laptop, Smartphone, Bot, Lightbulb, UserCheck
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface DigitalWorkforcePageProps {
  navigate?: (page: any) => void;
}

export function DigitalWorkforcePage({ navigate }: DigitalWorkforcePageProps) {
  ...
  return (
    <div className={`min-h-screen bg-background ${isRTL ? 'rtl' : ''}`}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Digital <span className="gradient-text-blue">Workforce</span>
              </motion.h1>
              ...
              >
                Transform your workforce with digital skills development and culture transformation. 
                From skills assessment to continuous upskilling, we create future-ready teams for digital success.
              </motion.p>
            </div>
            ...
            >
              ...
              >
                <span className={`flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
                  Start Workforce Transformation
      ...
      {/* Workforce Framework Section */}
      <section id="workforce-framework" className="py-16 lg:py-24 bg-gradient-to-br from-blue-50/30 to-background dark:from-blue-950/10 dark:to-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
              ...
              Workforce <span className="gradient-text-blue">Framework</span>
            </h2>
            <p className={`text-lg max-w-3xl mx-auto ${
              isDark ? 'text-slate-300' : 'text-slate-600'
            }`}>
              A comprehensive 4-phase approach to digital workforce transformation 
              that delivers measurable productivity gains and employee satisfaction.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {workforceFramework.map((step, index) => (
              <motion.div
                key={step.step}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
              ...
              Digital Workforce <span className="gradient-text-blue">Services</span>
            </h2>
            <p className={`text-lg max-w-3xl mx-auto ${
              isDark ? 'text-slate-300' : 'text-slate-600'
            }`}>
              Comprehensive workforce transformation services designed to build future-ready teams 
              and drive organizational digital success.
            </p>
          </motion.div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Start building your digital workforce today with our proven transformation methodology that delivers measurable results.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Free Consultation</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">No commitment, just insights</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Proven Results</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">70% productivity improvement</p>
                  </div>
                </div>
              </div>
            </div>
