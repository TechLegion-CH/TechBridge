...
import { 
  GraduationCap, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Users, BookOpen, Brain
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface DigitalUniversityPageProps {
  navigate?: (page: any) => void;
}

export function DigitalUniversityPage({ navigate }: DigitalUniversityPageProps) {
  ...
  const universityStats = [
    {
      ...
      icon: BookOpen,
      growth: "World-class education"
    },
    {
      title: "Students Enrolled",
      value: "50,000+",
      description: "Global learners community",
      icon: Users,
    ...
    },
    {
      ...
      value: "94%",
      description: "Student course completion",
      icon: Target,
      growth: "Exceptional engagement"
    },
    {
      title: "Industry Recognition",
      value: "98%",
      description: "Employer recognition rate",
      icon: Award,
      growth: "Industry validated"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Digital <span className="gradient-text-blue">University</span>
              </motion.h1>
              ...
              >
                Comprehensive digital education platform with 500+ courses and 50,000+ students. 
                94% completion rate with industry-validated curriculum and world-class learning experience.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Advance Your Digital Skills?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Join 50,000+ students in our comprehensive digital university with 500+ courses and 94% completion rate.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Learning Excellence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">500+ courses & 94% completion rate</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Industry Recognition</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">98% employer recognition & validation</p>
                  </div>
                </div>
              </div>
            </div>
