...
import { 
  Monitor, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Settings, Brain, Users, Clock, Award, 
  BarChart3, Calendar, Mail, Workflow, Layers, Network,
...
export function ProjectManagementPage({ navigate }: ProjectManagementPageProps) {
  ...
  const pmStats = [
    ...
    },
    {
      ...
      icon: Target,
      growth: "Cost excellence"
    },
    {
      title: "Quality Standards",
      value: "99%",
      description: "Quality gate compliance",
      icon: Award,
      growth: "Zero defects"
    },
    {
      ...
      value: "98%",
      description: "Project stakeholder satisfaction",
      icon: Users,
      growth: "Exceptional service"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Project <span className="gradient-text-blue">Management</span>
              </motion.h1>
              ...
              >
                Enterprise-grade project management with 97% on-time delivery. 
                Proven frameworks, agile methodologies, and risk management for successful digital transformation projects.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready for Enterprise Project Excellence?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Experience 97% on-time delivery with our proven project management frameworks and enterprise-grade methodologies.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Delivery Excellence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">97% on-time delivery & 95% budget adherence</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Quality Assurance</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">99% quality standards & 98% satisfaction</p>
                  </div>
                </div>
              </div>
            </div>
