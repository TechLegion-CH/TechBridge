...
import { 
  Radar, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Activity, Clock, BarChart3
} from "lucide-react";
...
export function TechRadarPage({ navigate }: TechRadarPageProps) {
  ...
  const radarStats = [
    {
      ...
      value: "1,000+",
      description: "Emerging technology monitoring",
      icon: Radar,
    ...
    },
    {
      ...
      value: "94%",
      description: "Technology prediction precision",
      icon: Target,
      growth: "Proven forecasting"
    },
    {
      title: "Market Analysis",
      value: "200+",
      description: "Technology market assessments",
      icon: BarChart3,
      growth: "Deep insights"
    },
    {
      title: "Innovation Cycles",
      value: "12",
      description: "Technology lifecycle tracking",
      icon: Activity,
      growth: "Complete monitoring"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Tech <span className="gradient-text-blue">Radar</span>
              </motion.h1>
              ...
              >
                Comprehensive technology radar tracking 1,000+ emerging technologies with 94% trend accuracy. 
                200+ market assessments and complete innovation cycle monitoring for strategic advantage.
              </motion.p>
            </div>
            ...
            >
              ...
              <Button
                ...
                onClick={() => navigate('digital-benchmarks')}
              >
                Digital Benchmarks
              </Button>
            </motion.div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Navigate Technology Trends?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access comprehensive tech radar tracking 1,000+ technologies with 94% accuracy and strategic market intelligence.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Technology Tracking</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">1,000+ technologies & 94% accuracy</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Market Intelligence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">200+ assessments & complete monitoring</p>
                  </div>
                </div>
              </div>
            </div>
