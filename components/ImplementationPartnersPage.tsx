...
import { 
  ...
  Wrench, Rocket, Shield
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ImplementationPartnersPageProps {
  navigate?: (page: any) => void;
}

export function ImplementationPartnersPage({ navigate }: ImplementationPartnersPageProps) {
  ...
  // Implementation Partnership Statistics
  const implementationStats = [
    {
      title: "Certified Partners",
      value: "150+",
      description: "Global implementation specialists",
      icon: UserCheck,
      growth: "Certified expertise"
    },
    {
      title: "Success Rate",
      value: "98%",
    ...
    },
    {
      ...
      value: "45",
      description: "Countries with local partners",
      icon: Globe,
      growth: "Worldwide presence"
    },
    {
      title: "Avg. Time to Value",
      value: "3-6M",
      description: "Months to see ROI",
      icon: Clock,
  ...
  const implementationBenefits = [
    ...
    },
    {
      ...
      value: "99.5%",
      description: "Bug-free deployment rate",
      icon: Shield
    },
    {
      title: "Cost Optimization",
      value: "35%",
      description: "Average implementation savings",
      icon: TrendingUp
    },
    {
      title: "Local Expertise",
      value: "100%",
      description: "Cultural & regulatory knowledge",
      icon: Users
    }
  ];
          ...
          >
            ...
            >
              ...
              <span className={`text-sm font-semibold ${isDark ? 'text-blue-300' : 'text-blue-600'}`}>
                Implementation & Delivery Excellence
              </span>
            ...
            <div className="space-y-6">
              ...
              >
                Implementation <span className="gradient-text-blue">Partners</span>
              </motion.h1>
              ...
              >
                Trusted network of 150+ certified implementation specialists. 
                Accelerated deployments, guaranteed quality, and local expertise for successful digital transformation worldwide.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Partner with our certified implementation specialists for 98% on-time delivery and 40% faster time-to-value.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Certified Excellence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">150+ certified implementation specialists</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Proven Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">98% on-time delivery rate worldwide</p>
                  </div>
                </div>
              </div>
            </div>
