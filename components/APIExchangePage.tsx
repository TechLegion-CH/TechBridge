...
import { 
  Plug, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Code, Globe, Shield,
  Database, Cloud, Lock, Activity
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface APIExchangePageProps {
  navigate?: (page: any) => void;
}

export function APIExchangePage({ navigate }: APIExchangePageProps) {
  ...
  const apiStats = [
    {
      title: "API Endpoints",
      value: "5,000+",
      description: "Verified APIs available",
      icon: Plug,
    ...
    },
    {
      ...
      value: "99.9%",
      description: "API uptime reliability",
      icon: Target,
    ...
    },
    {
      title: "Data Security",
      value: "100%",
      description: "Encrypted API transactions",
      icon: Shield,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                API <span className="gradient-text-blue">Exchange</span>
              </motion.h1>
              ...
              >
                Comprehensive API exchange with 5,000+ endpoints and 99.9% uptime reliability. 
                100K+ developers with 100% encrypted transactions and enterprise-grade security.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Connect with Our API Exchange?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 5,000+ API endpoints with 99.9% uptime and join 100K+ developers building with enterprise-grade security.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">API Excellence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">5,000+ endpoints & 99.9% uptime</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Developer Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">100K+ developers & 100% security</p>
                  </div>
                </div>
              </div>
            </div>
