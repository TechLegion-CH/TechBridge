...
import { 
  MapPin, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Users, Navigation
} from "lucide-react";
...
export function ClientJourneyPage({ navigate }: ClientJourneyPageProps) {
  ...
  const journeyStats = [
    {
      ...
      icon: Navigation,
      growth: "Structured approach"
    },
    {
      title: "Client Satisfaction",
      value: "98%",
      description: "End-to-end journey satisfaction",
      icon: Users,
      growth: "Exceptional experience"
    },
    {
      title: "Success Rate",
      value: "96%",
      description: "Complete journey success",
      icon: Target,
    ...
    },
    {
      ...
      value: "100%",
      description: "Continuous journey support",
      icon: Award,
      growth: "Lifetime partnership"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Client <span className="gradient-text-blue">Journey</span>
              </motion.h1>
              ...
              >
                Comprehensive 7-stage client journey with 98% satisfaction rate. 
                End-to-end transformation experience with 96% success rate and lifetime partnership support.
              </motion.p>
            </div>
            ...
            >
              ...
              <Button
                ...
                onClick={() => navigate('transformation-stories')}
              >
                Success Stories
              </Button>
            </motion.div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Experience our comprehensive 7-stage journey with 98% satisfaction rate and lifetime partnership support guaranteed.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Exceptional Experience</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">7 stages & 98% satisfaction rate</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Lifetime Partnership</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">96% success & ongoing support</p>
                  </div>
                </div>
              </div>
            </div>
