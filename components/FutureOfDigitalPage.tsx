...
import { 
  Rocket, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Brain, Eye, Calendar
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface FutureOfDigitalPageProps {
  navigate?: (page: any) => void;
}

export function FutureOfDigitalPage({ navigate }: FutureOfDigitalPageProps) {
  ...
  const futureStats = [
    ...
    },
    {
      ...
      value: "50+",
      description: "Identified breakthrough technologies",
      icon: Zap,
      growth: "Innovation radar"
    },
    {
      title: "Industry Impact",
      value: "85%",
      description: "Organizations transformation ready",
      icon: Target,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Future of <span className="gradient-text-blue">Digital</span>
              </motion.h1>
              ...
              >
                Future of digital transformation with 2030+ strategic roadmaps and 95% prediction accuracy. 
                50+ breakthrough technologies identified with 85% industry transformation readiness.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Shape the Future of Digital?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 2030+ strategic roadmaps with 95% prediction accuracy and prepare for 50+ breakthrough technologies.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Future Readiness</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">2030+ roadmaps & 95% accuracy</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Technology Innovation</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">50+ breakthroughs & 85% readiness</p>
                  </div>
                </div>
              </div>
            </div>
