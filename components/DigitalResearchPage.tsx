...
import { 
  FileText, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Users, BarChart3, Database,
  Search, Brain, Globe, Download, Eye, Calendar
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface DigitalResearchPageProps {
  navigate?: (page: any) => void;
}

export function DigitalResearchPage({ navigate }: DigitalResearchPageProps) {
  ...
  const researchStats = [
    {
      ...
      value: "500+",
      description: "Published research studies",
      icon: FileText,
    ...
    },
    {
      ...
      value: "50+",
      description: "Countries researched",
      icon: Globe,
    ...
    },
    {
      ...
      value: "10,000+",
      description: "Research citations received",
      icon: Award,
      growth: "Academic influence"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Digital <span className="gradient-text-blue">Research</span>
              </motion.h1>
              ...
              >
                Comprehensive digital research with 500+ published papers and global industry insights. 
                50+ countries analyzed with 10,000+ citations driving digital transformation knowledge.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Access Cutting-Edge Research?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 500+ research papers with global insights from 50+ countries and 10,000+ academic citations.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Research Excellence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">500+ papers & 10,000+ citations</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Global Coverage</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">50+ countries & 200+ industry reports</p>
                  </div>
                </div>
              </div>
            </div>
