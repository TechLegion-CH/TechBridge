...
import { 
  Network, TrendingUp, Target, CheckCircle, Star, 
  ArrowRight, Users, Award, Mail, Globe, Clock, Building
} from "lucide-react";
...
export function ChannelPartnersPage({ navigate }: ChannelPartnersPageProps) {
  ...
  const channelStats = [
    {
      ...
      value: "200+",
      description: "Authorized reseller network",
      icon: Network,
      growth: "Global reach"
    },
    {
      ...
      icon: Globe,
      growth: "Expanding presence"
    },
    {
      title: "Revenue Growth",
      value: "150%",
      description: "Average partner growth",
      icon: TrendingUp,
      growth: "Mutual success"
    },
    {
      title: "Certification Rate",
      value: "95%",
      description: "Certified sales teams",
      icon: Award,
      growth: "Expert enablement"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Channel <span className="gradient-text-blue">Partners</span>
              </motion.h1>
              ...
              >
                Powerful network of 200+ authorized resellers and channel partners. 
                Global market coverage across 60+ countries with 150% average revenue growth and certified expertise.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Join Our High-Growth Channel Network
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Partner with 200+ channel partners across 60+ countries. Experience 150% average revenue growth with certified sales enablement.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Global Network</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">200+ partners across 60+ countries</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Growth Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">150% average revenue growth</p>
                  </div>
                </div>
              </div>
            </div>
