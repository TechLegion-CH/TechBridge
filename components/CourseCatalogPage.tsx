...
import { 
  BookOpen, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Users, Brain, Clock
} from "lucide-react";
...
export function CourseCatalogPage({ navigate }: CourseCatalogPageProps) {
  ...
  const catalogStats = [
    ...
    },
    {
      ...
      value: "10,000+",
      description: "Total content hours",
      icon: Clock,
      growth: "Extensive coverage"
    },
    {
      title: "Skill Categories",
      value: "25+",
      description: "Digital skill domains",
      icon: Brain,
      growth: "Complete curriculum"
    },
    {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Course <span className="gradient-text-blue">Catalog</span>
              </motion.h1>
              ...
              >
                Extensive course catalog with 500+ learning paths and 10,000+ content hours. 
                25+ skill categories taught by 150+ expert instructors with industry-validated curriculum.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 500+ courses with 10,000+ content hours taught by 150+ expert instructors in 25+ digital skill categories.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Extensive Library</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">500+ courses & 10,000+ content hours</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Expert Instruction</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">150+ instructors & 25+ skill categories</p>
                  </div>
                </div>
              </div>
            </div>
