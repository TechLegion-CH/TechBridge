...
import { 
  ...
  ArrowRight, Shield, Mail, Users, GraduationCap, Trophy
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface CertificationProgramPageProps {
  navigate?: (page: any) => void;
}

export function CertificationProgramPage({ navigate }: CertificationProgramPageProps) {
  ...
  const certificationStats = [
    {
      ...
      icon: Award,
      growth: "Comprehensive portfolio"
    },
    {
      title: "Certified Professionals",
      value: "35,000+",
      description: "Successfully certified learners",
      icon: Users,
    ...
    },
    {
      ...
      icon: Shield,
      growth: "Global acceptance"
    },
    {
      title: "Career Advancement",
      value: "78%",
      description: "Post-certification promotion rate",
      icon: TrendingUp,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Certification <span className="gradient-text-blue">Program</span>
              </motion.h1>
              ...
              >
                Industry-recognized certification programs with 75+ credentials and 35,000+ certified professionals. 
                99% employer recognition with 78% post-certification promotion rate.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Earn Industry Recognition?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Join 35,000+ certified professionals with 75+ programs, 99% employer recognition, and 78% promotion rate.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">75+ programs & 99% employer recognition</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Career Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">35,000+ certified & 78% promotion rate</p>
                  </div>
                </div>
              </div>
            </div>
