...
import { 
  ...
  Shield, FileText, Factory, GraduationCap
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface VietnamHubPageProps {
  navigate?: (page: any) => void;
}

export function VietnamHubPage({ navigate }: VietnamHubPageProps) {
  ...
  const hubStats = [
    ...
    },
    {
      ...
      value: "$320B",
      description: "Annual manufacturing output",
      icon: Factory,
      growth: "Global supply chain"
    },
    {
    ...
    },
    {
      ...
      value: "85%",
      description: "SME digitization rate",
      icon: Smartphone,
  ...
  const vietnamBenefits = [
    {
      ...
      value: "$320B",
      description: "Annual output value",
      icon: Factory
    },
    {
      title: "Tech Talent",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Vietnam <span className="gradient-text-blue">Hub</span>
              </motion.h1>
              ...
              >
                Accelerating Vietnam's digital transformation through manufacturing digitization, fintech innovation, 
                and educational technology. Leveraging Vietnam's dynamic tech ecosystem and skilled workforce.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Accelerate Growth with Our Vietnam Hub
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Leverage Vietnam's dynamic tech ecosystem and 1M+ IT professionals to scale your digital transformation initiatives.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Tech Excellence</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">1M+ IT professionals & growing ecosystem</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Fast Growth</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">30% YoY digital economy growth</p>
                  </div>
                </div>
              </div>
            </div>
