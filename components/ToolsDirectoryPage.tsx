...
import { 
  Wrench, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Award, Mail, Search, Filter, Grid,
  Tool, Settings, Code
} from "lucide-react";
...
export function ToolsDirectoryPage({ navigate }: ToolsDirectoryPageProps) {
  ...
  const toolsStats = [
    {
      title: "Digital Tools",
      value: "3,000+",
      description: "Verified transformation tools",
      icon: Wrench,
      growth: "Comprehensive catalog"
    },
    {
      title: "Tool Categories",
      value: "50+",
      description: "Specialized tool categories",
      icon: Grid,
    ...
    },
    {
      title: "User Reviews",
      value: "250K+",
      description: "Real user experiences shared",
      icon: CheckCircle,
      growth: "Trusted feedback"
    },
    {
      title: "Success Stories",
      value: "95%",
      description: "Tool implementation success rate",
      icon: Target,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Tools <span className="gradient-text-blue">Directory</span>
              </motion.h1>
              ...
              >
                Comprehensive tools directory with 3,000+ verified digital transformation tools across 50+ categories. 
                250K+ user reviews with 95% implementation success rate and trusted effectiveness.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Discover the Perfect Tools?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Explore 3,000+ verified tools across 50+ categories with 250K+ reviews and 95% implementation success rate.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Tool Discovery</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">3,000+ tools & 50+ categories</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Proven Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">250K+ reviews & 95% success</p>
                  </div>
                </div>
              </div>
            </div>
