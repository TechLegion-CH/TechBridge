...
import { 
  Brain, TrendingUp, Target, CheckCircle, Star, 
  ArrowRight, Users, Award, Mail, Lightbulb, Globe, Clock
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface ConsultingPartnersPageProps {
  navigate?: (page: any) => void;
}

export function ConsultingPartnersPage({ navigate }: ConsultingPartnersPageProps) {
  ...
  const consultingStats = [
    {
      ...
      value: "75+",
      description: "Elite consulting firms worldwide",
      icon: Brain,
      growth: "Strategic excellence"
    },
    {
      title: "Combined Experience",
      value: "2000+",
      description: "Years of consulting expertise",
      icon: Award,
      growth: "Deep industry knowledge"
    },
    {
    ...
    },
    {
      ...
      value: "25+",
      description: "Specialized industry verticals",
      icon: Globe,
      growth: "Comprehensive expertise"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Consulting <span className="gradient-text-blue">Partners</span>
              </motion.h1>
              ...
              >
                Elite network of 75+ strategic consulting partners. 
                2000+ years of combined expertise delivering transformational strategies and sustainable business outcomes.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Partner with Strategic Consulting Experts
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 75+ elite consulting partners with 2000+ years of combined expertise for transformational strategies and sustainable outcomes.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Elite Expertise</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">75+ strategic consulting partners worldwide</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Proven Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">96% transformation success rate</p>
                  </div>
                </div>
              </div>
            </div>
