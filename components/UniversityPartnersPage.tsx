...
import { 
  GraduationCap, TrendingUp, Target, CheckCircle, Star, 
  ArrowRight, Users, Award, Mail, Globe, Clock, BookOpen
} from "lucide-react";
...
export function UniversityPartnersPage({ navigate }: UniversityPartnersPageProps) {
  ...
  const universityStats = [
    ...
    },
    {
      ...
      value: "5000+",
      description: "Successful graduate placements",
      icon: Users,
    ...
    },
    {
      title: "Global Reach",
      value: "35",
      description: "Countries with partnerships",
      icon: Globe,
      growth: "Worldwide network"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                University <span className="gradient-text-blue">Partners</span>
              </motion.h1>
              ...
              >
                Strategic partnerships with 100+ leading universities worldwide. 
                Collaborative research, talent development, and 5000+ successful graduate placements in digital transformation.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Collaborate with Academic Excellence
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Join 100+ leading universities in 250+ research projects. Build tomorrow's digital leaders with proven academic partnerships.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">250+ collaborative research projects</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Talent Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">5000+ successful graduate placements</p>
                  </div>
                </div>
              </div>
            </div>
