...
import { 
  BarChart3, Brain, TrendingUp, Eye, CheckCircle, Star, 
  ArrowRight, Database, Target, Globe, Monitor,
  Clock, Award, Zap, Search, Bell, MessageSquare,
  Calendar, Mail, Phone, Video, Headphones, Activity,
  Layers, Network, Settings, LineChart, PieChart
} from "lucide-react";
...
export function BusinessIntelligencePage({ navigate }: BusinessIntelligencePageProps) {
  ...
  return (
    <div className={`min-h-screen bg-background ${isRTL ? 'rtl' : ''}`}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Intelligent <span className="gradient-text-blue">Analytics</span>
              </motion.h1>
              ...
              >
                ...
                From interactive dashboards to predictive analytics, we turn data into your competitive advantage.
              </motion.p>
            </div>
      ...
      {/* BI Framework Section */}
      <section id="bi-framework" className="py-16 lg:py-24 bg-gradient-to-br from-blue-50/30 to-background dark:from-blue-950/10 dark:to-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
              ...
              BI <span className="gradient-text-blue">Framework</span>
            </h2>
            <p className={`text-lg max-w-3xl mx-auto ${
              isDark ? 'text-slate-300' : 'text-slate-600'
            }`}>
              A proven 4-phase business intelligence approach that delivers measurable insights 
              and drives data-driven decision making across your organization.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {biFramework.map((step, index) => (
              <motion.div
                key={step.step}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
              ...
              Business Intelligence <span className="gradient-text-blue">Services</span>
            </h2>
            <p className={`text-lg max-w-3xl mx-auto ${
              isDark ? 'text-slate-300' : 'text-slate-600'
            }`}>
              Comprehensive BI consulting services designed to transform your data into strategic business advantages 
              with modern analytics and intelligent insights.
            </p>
          </motion.div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Start making data-driven decisions 10x faster with our proven BI solutions that deliver measurable business intelligence.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Advanced Analytics</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">AI-powered insights</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Self-Service Platform</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">10x faster decisions</p>
                  </div>
                </div>
              </div>
            </div>
