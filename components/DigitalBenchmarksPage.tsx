...
import { 
  ...
  ArrowRight, Award, Mail, Users, Activity, Trophy
} from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";

interface DigitalBenchmarksPageProps {
  navigate?: (page: any) => void;
}

export function DigitalBenchmarksPage({ navigate }: DigitalBenchmarksPageProps) {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Digital <span className="gradient-text-blue">Benchmarks</span>
              </motion.h1>
              ...
              >
                Comprehensive digital benchmarks with 300+ industry standards and 5,000+ organizations analyzed. 
                150+ performance metrics tracked with 98% accuracy for trusted performance measurement.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Access 300+ industry benchmarks from 5,000+ organizations with 150+ metrics and 98% accuracy validation.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Industry Standards</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">300+ benchmarks & 98% accuracy</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Global Coverage</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">5,000+ organizations & 150+ metrics</p>
                  </div>
                </div>
              </div>
            </div>
