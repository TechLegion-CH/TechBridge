...
import { 
  Users, TrendingUp, Zap, Target, CheckCircle, Star, 
  ArrowRight, Brain, Award, Mail, Lightbulb, Clock, UserCheck
} from "lucide-react";
...
export function ChangeManagementPage({ navigate }: ChangeManagementPageProps) {
  ...
  const changeStats = [
    {
      title: "Adoption Rate",
      value: "92%",
      description: "Successful change adoption",
      icon: UserCheck,
    ...
    },
    {
      ...
      value: "75%",
      description: "Lower resistance to change",
      icon: TrendingUp,
      growth: "Proven approach"
    },
    {
      title: "Time to Adoption",
      value: "50%",
      description: "Faster user adoption",
      icon: Clock,
    ...
    },
    {
      ...
      value: "89%",
      description: "Post-change engagement",
      icon: Users,
      growth: "Sustained success"
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Change <span className="gradient-text-blue">Management</span>
              </motion.h1>
              ...
              >
                Strategic organizational change management with 92% adoption success rate. 
                Human-centered approach to transformation ensuring sustainable adoption and cultural evolution.
              </motion.p>
            </div>
            ...
            <div className="glass-heavy rounded-3xl p-12 text-center relative overflow-hidden border-2 border-blue-300 dark:border-blue-600/50 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4 transition-colors duration-300">
                  Ready to Lead Successful Organizational Change?
                </h3>
                ...
                <div className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
                  Achieve 92% adoption success with our proven change management strategies and human-centered transformation approach.
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12 pt-8 border-t border-blue-200 dark:border-blue-600/50 transition-colors duration-300">
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Adoption Success</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">92% adoption rate & 75% resistance reduction</p>
                  </div>
                  <div className="text-center">
                    <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300">Sustainable Change</h4>
                    <p className="text-slate-600 dark:text-slate-400 transition-colors duration-300">89% engagement & long-term success</p>
                  </div>
                </div>
              </div>
            </div>
